...
@class CXGraphWindowController;
//@class CXDocument;

@interface CXGraphView : NSView {
  IBOutlet CXGraphWindowController *graphController;
  NSCell *textCell; // I access this directly, ie no accessor method
}
